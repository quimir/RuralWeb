...
export const mockTourismSpots = [
  {
    id: 1,
    title: "张三采摘园",
    summary: "体验亲手采摘新鲜草莓的乐趣，适合家庭周末游。",
    content: "体验亲手采摘新鲜草莓的乐趣，适合家庭周末游。园区占地50亩，种植多种有机水果。",
    type: "PICKING_GARDEN",
  ...
  },
  {
    id: 2,
    title: "李家村特色农家乐",
    summary: "品尝地道农家菜，体验乡村慢生活，提供住宿。",
    content: "品尝地道农家菜，体验乡村慢生活，提供住宿。院落宽敞，可容纳30人同时就餐。",
    type: "FARMSTAY",
  ...
  },
  {
    id: 3,
    title: "绿野农事体验园",
    summary: "天然氧吧，徒步、骑行、露营的绝佳去处。",
    content: "天然氧吧，徒步、骑行、露营的绝佳去处。提供农事体验项目：插秧、磨豆腐、制茶等。",
    type: "AGRI_EXPERIENCE",
...
export const mockRoutes = [
  {
    ...
    days: [
      ...
      },
      {
        ...
        date: "2026-03-21",
        spots: [
          { itemId: 2, spotId: 3, spotName: "绿野农事体验园", coverImage: "https://picsum.photos/seed/spot3/600/400", type: "AGRI_EXPERIENCE", address: "浙江省杭州市临安区XX山", sortOrder: 1, visitTime: "08:30", durationMinutes: 240, notes: "徒步+野餐" },
        ],
      },
    ],
  },
